...
function StatusBadge({ status }: { status: Status }) {
  ...
  return (
    <Badge variant="outline" className={`text-[11px] font-mono tracking-wide ${className}`}>
      {label}
    </Badge>
  );
}
  ...
  return (
    <Card className="relative overflow-hidden border-border/60">
      ...
      <CardHeader className="pb-2 pt-5">
        ...
        <CardDescription className="font-mono text-[11px] tracking-widest uppercase mt-3">
          {label}
        </CardDescription>
      </CardHeader>
      <CardContent>
